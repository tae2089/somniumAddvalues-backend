package bin.study.memo.service.dev;
...
public class EmailServiceDev implements EmailServiceImpl {
    @Autowired
...
// authkey코등 생성하기
        try {
            ...
            String url = "http://13.124.76.138:3000/email/certification?authkey="+token;
    ...
    public EmailError sendPasswordMail(String email) throws MessagingException {
        ...
        if(user != null){
            ...
            //메시지 내용
            String message = "http://13.124.76.138:3000/change-password?token="+token;
            // 받는 사람
