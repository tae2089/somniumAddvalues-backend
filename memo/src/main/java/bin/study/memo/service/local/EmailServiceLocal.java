package bin.study.memo.service.local;
...
public class EmailServiceLocal implements EmailServiceImpl {
    @Autowired
...
// authkey코등 생성하기
        try {
            ...
            String url = "http://127.0.0.1:3000/email/certification?authkey="+token;
    ...
    public EmailError sendPasswordMail(String email) throws MessagingException {
        ...
        if(user != null){
            ...
            //메시지 내용
            String message = "http://127.0.0.1:3000/change-password?token="+token;
            // 받는 사람
